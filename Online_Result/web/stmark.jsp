...
margin: 0;
    ...
    <body>
        ...
        <%
        while(rs.next()){
            out.println("<a href='showrankS.jsp?semid="+rs.getInt(1)+"'>Sem "+i+"</a>");
            i++;
        }
        %>
         </div>   
        ...
        %>
        <div align="center" class="container borderYtoX"><a href="studentDash.jsp?email=<%=session.getAttribute("student_email")%>&password=<%=session.getAttribute("student_password")%>">Dashboard</a></div>
