...
a:link, a:visited {
    ...
    <body onload="change()" onclick="stop()">
       ...
       %>     
        ...
        <div class="container borderYtoX"><a href="myresult.jsp">Go back</a></div><br><br>
        <div class="container borderYtoX"><a href="finalprint.jsp?semid=<%=sem%>">Print Result</a></div>
        <%
        }
