<%-- 
    Document   : ranking
    Created on : Jan 12, 2022, 6:17:41 PM
    Author     : asus
--%>
...
margin: 0;
    ...
    <body>
        ...
        <%
        while(rs.next()){
            out.println("<a href='showrank.jsp?semid="+rs.getInt(1)+"'>Sem "+i+"</a>");
            i++;
        }
        %>
        ...
        %>
        <br><br><div align="center" class="container borderYtoX"><a href="tseeS.jsp">Go back to Rankings</a></div>
        <br><br><div align="center" class="container borderYtoX"><a href="teacherDash.jsp?email=<%=session.getAttribute("teacher_email")%>&password=<%=session.getAttribute("teacher_password")%>">Go back to DAshboard</a></div>
