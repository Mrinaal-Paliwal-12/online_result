<%-- 
    Document   : showrank
    Created on : Jan 12, 2022, 7:38:59 PM
    Author     : asus
--%>
...
a:link, a:visited {
    ...
    <body>
        ...
        <br><br><div class="container borderYtoX"><a href="ranking.jsp?bid=<%=session.getAttribute("bid")%>">Select another Semester</a>
        <a href="teacherDash.jsp?email=<%=session.getAttribute("teacher_email")%>&password=<%=session.getAttribute("teacher_password")%>">Go back to DAshboard</a></div>
        <%
