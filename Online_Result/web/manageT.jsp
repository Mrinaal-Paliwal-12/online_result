<%-- 
    Document   : manageT
    Created on : Jan 10, 2022, 2:17:44 PM
    Author     : asus
--%>
...
background: linear-gradient(to left, #237A57, #093028); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
  ...
  font-size: 15px;
    ...
    <body>
        ...
        PreparedStatement ps = con.prepareStatement("select teacher_id from teacher order by teacher_id desc");
        ResultSet rs = ps.executeQuery();
        rs.next();
        int autoid = rs.getInt(1) + 1;
        %>
        <h1>Manage teachers , welcome <%=session.getAttribute("admin_name")%></h1><br><BR>
        <div class="center"><div>
        <form action="viewT.jsp" method="get">
            <fieldset style="height:400px ; width:250px ;">
            <h3 class="font-effect-outline">View Teachers</h3><hr/><br>
        ...
        <div>
        <form action="updateT.jsp" method="get">
            <fieldset style="height:400px ; width:250px ;">
            <h3 class="font-effect-outline">Update Teacher Batch</h3><hr/><br>
            <input class="inpw" type="text" name ="tid" placeholder="Enter teacher id"><br><br>
            
            <label class="font-effect-outline" for="11">MCA</label>&nbsp;
            <input type="radio" name="course" value="11" id="11"/>
            
            <label class="font-effect-outline" for="12">MBA</label>
            <input type="radio" name="course" value="12" id="12"/>
            <br><br><br><br><br><br><br><br><br><br>
            <input type="submit" class="btn"/>&nbsp;&nbsp;&nbsp;<input type="reset" class="btn reset" />
            </fieldset>
        </form></div>
        <div>
        <form action="insertT.jsp" method="get" >
            <fieldset style="height:400px ; width:250px ;">
            <h3 class="font-effect-outline">Insert teacher</h3><hr/><br>
            <input type="text" name ="tid" value="<%out.println(autoid);%>" readonly  class="inpw"><br><br>
            
            <input type="text" name ="tname" placeholder="Enter teacher Name"  class="inpw"><br><br>
            <input type="email" name ="temail" placeholder="Enter email-id"  class="inpw"><br><br>
            <input type="password" name ="tpass" placeholder="Give password"  class="inpw"><br><br>
            
            <label class="font-effect-outline" for="11">MCA</label>&nbsp;
            <input type="radio" name="course" value="11" id="11"/>
            
            <label class="font-effect-outline" for="12">MBA</label>
            <input type="radio" name="course" value="12" id="12"/><br><br><br>
            
            <input type="submit" class="btn"/>&nbsp;&nbsp;&nbsp;<input type="reset" class="btn reset" />
            </fieldset>
        </form></div>
        <div>
        <form action="deleteT.jsp" method="get">
            <fieldset style="height:400px ; width:250px ;">
            <h3 class="font-effect-outline">Delete teacher records</h3><hr/><br>
            <input type="text" name ="tid" placeholder="Enter teacher id"  class="inpw"><br><br>
            <input type="password" name ="pass" placeholder="Enter your password"  class="inpw"><br><br>
            ...
            <div><a href="adminDash.jsp?email=<%out.println(rs.getString(1));%>&password=<%out.println(rs.getString(2));%>">Dashboard</a></div>
